# Lighthouse (desktop) — 2026-09-23T16:04:25.897Z
...
- Use efficient cache lifetimes (Est savings of 19 KiB)
    · {"url":"https://aiphantomtraders.com/cdn-cgi/challenge-platform/h/b/scripts/jsd/d76008a69eab/main.js?","cacheLifetimeMs":14400000,"wastedBytes":6675.5599999999995}
...
- Reduce unused CSS (Est savings of 19 KiB)
    · {"url":":root{--bg-base:#0a0c0f;--bg-elev-1:#14161a;--bg-elev-2:#1c1f25;--bg-elev-3:#262a31;--reactor-blue:…","wastedBytes":19761,"wastedPercent":92.47273893521488,"totalBytes":21370}
- Reduce unused JavaScript (Est savings of 154 KiB)
    · {"url":"https://www.googletagmanager.com/gtag/js?id=G-T8NHESJZ90","totalBytes":175896,"wastedBytes":72147,"wastedPercent":41.01708807075396}
    · {"url":"https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2","totalBytes":55848,"wastedBytes":46643,"wastedPercent":83.51654897791789}
    · {"url":"https://aiphantomtraders.com/","totalBytes":75121,"wastedBytes":38889,"wastedPercent":51.76849852498403}
...
- Avoid an excessive DOM size (3,757 elements)
    · {"statistic":"Total DOM Elements","value":{"type":"numeric","granularity":1,"value":3757}}
...
- Uses deprecated APIs (2 warnings found)
    ...
    · {"value":"Fledge","source":{"type":"source-location","url":"https://aiphantomtraders.com/cdn-cgi/challenge-platform/scripts/jsd/main.js","urlProvider":"network","line":0,"column":3610}}
